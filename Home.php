...
<?php
	if(isset($_POST['delete_warning']))
	{
		...
		mysqli_query($link,"delete from user_warning where user_id=$user_warning_id;");
	}
	if(isset($_POST['delete_notice']))
	{
		$n_id=intval($_POST['notice_id']);
		mysqli_query($link,"delete from users_notice where notice_id=$n_id;");
	}
	if(isset($_POST['txt']))
	{
		$txt=$_POST['post_txt'];
...
<body id="body">
<?php
	$que_warning=mysqli_query($link,"select * from user_warning where user_id=$userid");
...
<?php
	$que_notice=mysqli_query($link,"select * from users_notice where user_id=$userid");
...
?>
	...
	<div style="position:absolute; left:24%; top:8%;"> <img src="img/Status.PNG"><input type="button" onClick="upload_close();"  value="Update Status" style="background:#FFFFFF; border:#FFFFFF;"> <img src="img/photo&video.PNG"><input type="button"  value="Add Photos" onClick="upload_open();" name="file" style="background:#FFFFFF; border:#FFFFFF;"></div>
<div style=" background:#F2F2F2; position:absolute; left:21%; top:28.5%; height:6.5%; width:41.4%; z-index:-1;"> </div>
<form method="post" name="posting_txt" onSubmit="return blank_post_check()" id="post_txt">
	...
	<div style="position:absolute; left:21.3%; top:11.5%;">
		<textarea style="height:100; width:400;" name="post_txt" maxlength="511" placeholder="What's on your mind?"></textarea>
...
<option value="Private"> Only me </option> 
	...
	<div style="position:absolute;left:19%; top:39%;margin-right:430;">
	<table cellspacing="0">
        
          
                <?php
	$que_post=mysqli_query($link,"select * from user_post where priority='Public' order by post_id desc");
...
?>
	...
	?>
 	...
 	<tr>
		<td width="5%" style="padding-left:25;" rowspan="2"> <img src="../../fb_users/<?php echo $user_gender; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
...
<?php
	...
	<tr>
		<td>   </td>
		<td colspan="3"><img src="../../fb_users/<?php echo $user_gender; ?>/Post/<?php echo $post_img; ?>" width="600" height="400"> </td>
		<td> </td>
		<td> </td>
	</tr>
	<?php
...
?>
	...
	<td width="4%" style="padding-left:17;" bgcolor="#EDEFF4" rowspan="2">  <img src="../../fb_users/<?php echo $gender; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;">    </td>
		...
		<input type="text" name="comment_txt" placeholder="Write a comment..." maxlength="300" style="width:240;" id="<?php echo $postid;?>"> 
		<input type="hidden" name="postid" value="<?php echo $postid; ?>"> 
		<input type="hidden" name="userid" value="<?php echo $userid; ?>"> 
