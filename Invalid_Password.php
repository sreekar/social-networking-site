...
<LINK REL="SHORTCUT ICON" HREF="fb_files/fb_title_icon/web.ico" />
	<style>
		...
		#login_button
		{
			...
			width:49;
			padding:2;
			background-color:#0E4456; color:#FFFFFF;
			border-top:#29447E;
...
<div style="position:absolute;left:0;top:0; height:13%; width:100%; z-index:-1; background:#0E4456">   </div>
<div style="position:absolute;left:13.5%;top:2.5%;">  <a href="index.php" style="text-decoration:none; font-size:50;font-weight:900; color:#FFFFFF;"> <font face="myFbFont"> blank </font> </a> </div> </div> 
...
<div style="position:absolute; left:27.4%; top:28.2%;">  <font size="4"><b> blank Login </b></font>  </div>
...
<div style="position:absolute; left:28%; top:42.2%; font-size:12;">  The password you entered is incorrect. Please try again .  </div>
<div style="position:absolute; left:28%; top:45.2%; font-size:12;">  (make sure your caps lock is off)   </div>
<div style="position:absolute; left:28%; top:47.2%; font-size:12;">  Forgot your password? Request a new one. Make sure that it is   </div>
...
<form  method="post">
	...
	<div style="position:absolute;left:49%;top:71.7%; "> <a href="index.php" style="color:#3B5998;text-decoration:none;"> <b>Sign up for blank</b> </a> </div>
