...
<div style="position:absolute;left:27.4%; top:36.2%; height:1; width:44.05%; background-color:#DD3C10; "> </div>
	...
	<div style="position:absolute; left:28%; top:46.2%; font-size:12;">  You can login using any email, username associated with your account   </div>
	<div style="position:absolute; left:28%; top:48.7%; font-size:12;"> Make sure that it is typed correctly.  </div>
