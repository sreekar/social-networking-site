...
<?php
	if(isset($_POST['txt']))
	{
		...
		mysqli_query($link,"insert into user_post(user_id,post_txt,post_time,priority) values('$userid','$txt','$post_time','$priority');");
	}
	...
	if(isset($_POST['file']) && ($_POST['file']=='post'))
	{
		...
		if($gender=="Male")
		{
			$path = "../../fb_users/Male/Post/";
		}
		else
		{
			$path = "../../fb_users/Female/Post/";
		}
		
		$img_name=rand().$_FILES['file']['name'];
    	$img_tmp_name=$_FILES['file']['tmp_name'];
    	$prod_img_path=$img_name;
		if($gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../fb_users/Male/Post/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../fb_users/Female/Post/".$prod_img_path);
		}
    	mysqli_query($link,"insert into user_post(user_id,post_txt,post_pic,post_time,priority) values('$userid','$txt','$img_name','$post_time','$priority');");
	}
	if(isset($_POST['delete_post']))
	{
		$post_id=intval($_POST['post_id']);
		mysqli_query($link,"delete from user_post where post_id=$post_id;");
	}
	if(isset($_POST['Like']))
	{
		$post_id=intval($_POST['postid']);
		$user_id=intval($_POST['userid']);
		mysqli_query($link,"insert into user_post_status(post_id,user_id,status) values($post_id,$user_id,'Like');");
	}
	if(isset($_POST['Unlike']))
	{
		$post_id=intval($_POST['postid']);
		$user_id=intval($_POST['userid']);
		mysqli_query($link,"delete from user_post_status where post_id=$post_id and  	user_id=$user_id;");
	}
	if(isset($_POST['comment']))
	{
		...
		if($txt!="")
		{
		mysqli_query($link,"insert into user_post_comment(post_id,user_id,comment) values($post_id,$user_id,'$txt');");
		}
	}
	if(isset($_POST['delete_comment']))
	{
		$comm_id=intval($_POST['comm_id']);
		mysqli_query($link,"delete from user_post_comment where comment_id=$comm_id;");
	}
?>
<html>
<head>
...
<?php
	$que_post_img=mysqli_query($link,"select * from user_post where user_id=$userid and post_pic!='' order by post_id desc");
	$photos_count=mysqli_num_rows($que_post_img);
	$photos_count=$photos_count+$count1+1;
?>

<div style="position:absolute;left:37.5%; top:54%; font-weight:bold; z-index:1;">  Timeline  </div>
...
<div style="position:absolute;left:46.3%; top:54%; font-weight:bold; z-index:1;"> <a href="about.php" style="text-decoration:none; color:#3B59B0;" onMouseOver="on_about_txt();" onMouseOut="out_about_txt();"> About </a>  </div>
...
<div style="position:absolute;left:52.7%; top:54%; font-weight:bold; z-index:1; color:#3B59B0;"> <a href="photos.php" style="text-decoration:none; color:#3B59B0;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php echo $photos_count; ?> </samp> </div>
...
<?php
	$que_post_bg1=mysqli_query($link,"select * from user_post where user_id=$userid");
...
<div style="position:absolute;left:37.3%; top:96%;margin-right:200;">
<table cellspacing="0">
<?php
	$que_post=mysqli_query($link,"select * from user_post where user_id=$userid order by post_id desc");
	while($post_data=mysqli_fetch_array($que_post))
	{
		...
		$que_user_info=mysqli_query($link,"select * from users where user_id=$post_user_id");
		$que_user_pic=mysqli_query($link,"select * from user_profile_pic where user_id=$post_user_id");
...
?>
	<tr>
		...
		<tr>
		<td width="5%" style="padding-left:10;" rowspan="2"> <img src="../../fb_users/<?php echo $user_gender; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
...
<?php 
	...
	<tr>
		<td>   </td>
		<td colspan="3"><img src="../../fb_users/<?php echo $user_gender; ?>/Post/<?php echo $post_img; ?>" width="400" height="400"> </td>
		<td> </td>
		<td> </td>
	</tr>
	<?php
	...
	<tr style="color:#6D84C4;">
		<td >   </td>
		<?php
		 	$que_status=mysqli_query($link,"select * from user_post_status where post_id=$postid and user_id=$userid;");
			$que_like=mysqli_query($link,"select * from user_post_status where post_id=$postid");
		...
		<input type="submit" value="Like" name="Like" style="border:#FFFFFF; background:#FFFFFF; font-size:15px; color:#6D84C4;" onMouseOver="like_underLine(<?php echo $postid; ?>)" onMouseOut="like_NounderLine(<?php echo $postid; ?>)" id="like<?php echo $postid; ?>"></form></td>
		 ...
		 <?php
		 	...
		 	$que_comment=mysqli_query($link,"select * from user_post_comment where post_id =$postid order by comment_id");
...
<?php
	while($comment_data=mysql_fetch_array($que_comment))
	{
		...
		$que_user_info1=mysqli_query($link,"select * from users where user_id=$comment_user_id");
		$que_user_pic1=mysqli_query($link,"select * from user_profile_pic where user_id=$comment_user_id");
...
?>
	...
	<tr>
		<td> </td>
		<td width="4%" bgcolor="#EDEFF4" style="padding-left:12;" rowspan="2">  <img src="../../fb_users/<?php echo $user_gender1; ?>/Profile/<?php echo $user_pic1; ?>" height="40" width="47">    </td>
...
<tr>
	<td> </td>
	<td width="4%" style="padding-left:17;" bgcolor="#EDEFF4" rowspan="2">  <img src="../../fb_users/<?php echo $gender; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;">    </td>
...
<?php
	$user_info_query=mysqli_query($link,"select * from user_info where user_id=$userid");
...
?>
	<div style="position:absolute; left:15.5%; top:108%;"> <img src="../../fb_users/<?php echo $gender; ?>/Profile/<?php echo $img_array[0] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:108%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[1] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:108%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[2] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:125%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[3] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:125%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[4] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:125%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[5] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:142%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[6] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:142%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[7] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:142%;"> <img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $img_array[8] ?>" height="90" width="78">  </div>
