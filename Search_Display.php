...
?>
			...
			<td bgcolor="#FFFFFF" style="padding-left:5;" id="Photo<?php echo $uid; ?>"> <a href="Profile.php">  <img src="../../fb_users/<?php echo $gender; ?>/Profile/<?php echo $img; ?>" style="height:70; width:70;"> </a> </td>
...
?>
			...
			<td bgcolor="#FFFFFF" style="padding-left:5;" id="Photo<?php echo $uid; ?>"> <a href="../fb_view_profile/view_profile.php?id=<?php echo $uid; ?>">  <img src="../../fb_users/<?php echo $gender; ?>/Profile/<?php echo $img; ?>" style="height:70; width:70;"> </a> </td>
