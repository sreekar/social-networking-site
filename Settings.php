...
<?php
	if(isset($_POST['change_name']))
	{
		...
		mysqli_query($link,"update users set Name='$Name' where user_id=$userid;");
	...
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query($link,"update users set Password='$new_password' where user_id=$userid;");
		}
		else
		{
	...
	{
		$uid=$_POST['uid'];
		mysqli_query($link,"delete from users where user_id=$uid;");
