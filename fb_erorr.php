...
<body>
	...
	<!-- erorr Designing -->
		...
		<div style="position:absolute;left:59.3%; top:90%; height:5%; width:40%; z-index:1; background:#FFEBE8; box-shadow:5px 0px 10px 1px rgb(150,0,0); ">   </div>
		...
		<div id="blank_error" style="display:none; position:absolute; left:60%; top:90.7%; z-index:1"> You must fill in all of the fields. </div>
