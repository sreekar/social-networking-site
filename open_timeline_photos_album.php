...
<?php
	...
	$que_user_info=mysqli_query($link,"select * from users where Email='$user'");
	$user_data=mysqli_fetch_array($que_user_info);
	$gender=$user_data[4];
	
	$que_post_img=mysqli_query($link,"select * from user_post where post_id=$id");
...
<img src="../../fb_users/<?php echo $gender; ?>/Post/<?php echo $post_img_data[3]; ?>" style="height:500; width:800; ">
</div>
</div>
