...
{
	document.getElementById("Photo"+uid).bgColor = "#0E4456";
	document.getElementById("Photo"+uid).style.color="#FFFFFF";
	document.getElementById("Name_bg"+uid).bgColor = "#0E4456";
...
function searched_out(uid)
{
	...
	document.getElementById("Photo"+uid).style.color="#0E4456";
	document.getElementById("Name_bg"+uid).bgColor = "#FFFFFF";
	document.getElementById("Name_font"+uid).style.color="#0E4456";	
}
function see_more_over()
{
	document.getElementById("see_more").bgColor = "#0E4456";
...
function see_more_out()
{
	...
	document.getElementById("see_more_text").style.color="#0E4456";
}
